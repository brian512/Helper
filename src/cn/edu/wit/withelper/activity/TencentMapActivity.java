...
public class TencentMapActivity extends MapActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				overridePendingTransition(SwitchActivityAnim.downIn(),
						SwitchActivityAnim.downOut());
			}
		});
	...
	private void openStreetView(GeoPoint geoPoint) {
		if (null == lastPoint
				|| (Math.abs(lastPoint.getLatitudeE6()
						- geoPoint.getLatitudeE6()) > 50 && Math.abs(lastPoint
						.getLongitudeE6() - geoPoint.getLongitudeE6()) > 50)
				|| !isOpenStreetView
